...
const form_fields = ['name', 'manufacturer', 'price', 'description', 'sale_end_date', 'story_text', 'story_template', 'product_template', 'num_items_limit', 'variant_type_description']
const form_labels = ['Name', 'Manufacturer', 'Price', 'Description', "Sale End Date", 'Story Text', 'Story Template', 'Product Template', 'Item Limit', 'Variant Type Description (color, size, etc)']
		...
		if (!this.state.product.has_variants) {
			...
			var toggle_variants = (
				<div>
					...
					<button  type = "button" className = "btn btn-default" 
						onClick = {this.toggleProductHasVariants.bind(this, true)}>
						Allow Variants
					</button>
				</div>
			)
			...
			var toggle_variants = (
				<div>
					...
					<button  type = "button" className = "btn btn-default" 
						onClick = {this.toggleProductHasVariants.bind(this, false)}>
						Remove Variants
					</button>
				</div>
			)
