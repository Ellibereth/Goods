...
const form_fields = ['name', 'description', 'price', 'sale_text_product', 'sale_text_home', 'sale_end_date', 'category', 'product_template', 'num_items_limit', 'quadrant1', 'quadrant2', 'quadrant3', 'quadrant4', 'product_search_tags', 'product_listing_tags', 'related_product_tags']
const form_labels = ['Name', 'Mobile Description', 'Original Price (make sure this is in cents)', 'Sale Red Text Product (this is HTML)', 'Sale Red Text Home (this is HTML)', 'Sale End Date', 'Category', 'Product Template', 'Item Limit', 'Quadrant 1', 'Quadrant 2', 'Quadrant 3', 'Quadrant 4', 'Search Tags (Separate by commas)', 'Listing Tags (Separate by commas)', 'Related Product Tags (Separate by commas)']
const input_types = ['text', 'textarea', 'text', 'textarea', 'textarea', 'datetime-local', 'text', 'text', 'text', 'textarea', 'textarea', 'textarea', 'textarea', 'textarea', 'textarea','textarea','textarea']
