...
const form_fields = ['name', 'manufacturer', 'manufacturer_email', 'sale_price', 'price', 'sale_text_product', 'sale_text_home', 'sale_end_date', 'category', 'product_template', 'num_items_limit', 'manufacturer_fee', 'quadrant1', 'quadrant2', 'quadrant3', 'quadrant4', 'tags']
const form_labels = ['Name', 'Manufacturer', 'Manufacturer Emails (separate with commas)', 'Sale Price', 'Original Price (make sure this is in cents)', 'Sale Red Text Product (this is HTML)', 'Sale Red Text Home (this is HTML)', "Sale End Date", 'Category', 'Product Template', 'Item Limit', 'Manufacturer Fee..this value is stored in ten thousands, so 500 => 5%', 'Quadrant 1', 'Quadrant 2', 'Quadrant 3', 'Quadrant 4', 'Tags (Separate by commas) and use upper case only for categories. Otherwise all lower case for search']
const input_types = ['text', 'text', 'text', 'text', 'text', 'textarea', 'textarea', 'datetime-local', 'text', 'text', 'text', 'text', 'textarea', 'textarea', 'textarea', 'textarea', 'textarea']
