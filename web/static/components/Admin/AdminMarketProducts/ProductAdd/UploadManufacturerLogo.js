...
export default class UploadManufacturerLogo extends React.Component {
	constructor(props) {
		super(props)
		this.state = {
			image_data : ''
	...
	handleImageChange(product_id) {
		var input_id = product_id + '_upload_logo'
	...
	render() {
		...
		return (
			<form className = "form-horizontal">
				...
				<input type = "file" placeholder="Image" id= {product.product_id + '_upload_logo'} className="form-control"
					accept="image/*" 
