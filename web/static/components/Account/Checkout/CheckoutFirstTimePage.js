...
export default class CheckoutFirstTimePage extends React.Component {
	constructor(props){
		super(props);
		this.state = {
			items : [],
			price : null,
			use_same_for_billing : true,
			address_name : "",
			description : "",
			address_state: "",
			address_city : "",
			...
			<div>
				...
				<div className = "container">
					<div className = "col-sm-10 col-md-10 col-lg-10">
						...
						<form>
							<div class="radio">
							  <label><input onChange = {this.onUseSameAddressChange.bind(this)} value = {true}  selected type="radio" name="use_same"/> Yes </label>
							</div>
							<div class="radio">
							  <label><input onChange = {this.onUseSameAddressChange.bind(this)} value = {false} type="radio" name="use_same"/> No (If not, we'll ask for it in a moment) </label>
							</div>
						</form>
