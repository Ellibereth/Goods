...
export default class CheckoutPriceRow extends React.Component {
	...
	render() {
		...
		var has_line_through_style = this.props.line_through ? {textDecoration: "line-through"} : {}
		return (
			<div className = "row">
				...
				<div className = "col-lg-6 col-md-6 col-sm-6 col-xs-6">
					<span style = {has_line_through_style} 
					className = {label_class}>
						 {this.props.label} 
					</span>
				</div>
				<div className = "col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right">
					<span style = {has_line_through_style} className = {amount_class}>
						{this.props.price}
					</span>
