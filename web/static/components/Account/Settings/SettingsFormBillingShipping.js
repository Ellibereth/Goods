...
const form_labels = ['Street Addtess', "City", "State", "Zip Code" , "Phone Number"]
const form_inputs = ["street_address", "city", "state", "zip_code" , "phone_number"]
const input_types = ['text', 'text', 'text', 'text', 'text']

export default class SettingsFormBillingShipping extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			street_address: "",
