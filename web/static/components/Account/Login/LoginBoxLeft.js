...
export default class LoginBox extends React.Component {
	...
	render() {
		...
		return (
				<div className="inviteBlock fab-col-sm-30" id="resInviteMsg">
					...
					<input style = {register_styles} onClick = {this.props.setFormState.bind(this, LOGIN_STATE)} className={" font13 fabSubmitBtn fabGradNew borderR3 noShadow"} id="requestInvite" type="button" value="Sign Up"/>
