  ...
  <div className="hidden-xs fab-col-sm-60">
    <div className="fab-row">
        <div className="fab-col-xs-60 fab-col-sm-29">
          <div className="new-heading-2  fab-color-black margin-bottom-15">Description</div>
...
<li><span style={{"line-height" : "1.231"}}>16” x 16”</span></li>

<li><span style={{"line-height" : "1.231"}}>Zipper shell with concealed zipper</span></li>

<li><span style={{"line-height" : "1.231"}}>Double sided print</span></li>

<li><span style={{"line-height" : "1.231"}}>Pillow insert included (handwash only)</span></li>

<li><span style={{"line-height" : "1.231"}}>Printed on soft and super smooth fabric great for showing print detail</span></li>

<li><span style={{"line-height" : "1.231"}}>This item is made to order and will ship to you directly from the designer. Please allow for extra shipping time.</span></li>
