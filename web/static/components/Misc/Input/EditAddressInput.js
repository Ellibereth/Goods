...
export default class EditAddressInput extends React.Component {
	constructor(props) {
		super(props);
	}
	...
	render() {
		...
		<form id = "address_form" className="form-horizontal">
			...
			<div className="form-group">
			    ...
			    <input value = {address.address_name} field = "address_name" onChange = {this.handleChange.bind(this)}
			     id="Name" name="name" type="text" placeholder="Name on Address" className="form-control input-md" required=""/>
			    </div>
			</div>

			{
				...
				<div className="form-group">
				    ...
				    <div className="col-md-6">
				    <input value = {address.description} tabindex= {tab_index_start + 2} field = "description" onChange = {this.handleChange.bind(this)}
			...
			<div className="form-group">
				...
				id="State" name="address_state" className="form-control" value = {address.address_state}>
			...
			<div className="form-group">
			    ...
			    id="city" name="address_city" type="text" placeholder="city or town" className="form-control input-md"
			...
			<div className="form-group">
			    ...
			    <input tabindex= {tab_index_start + 6} 
			    value = {address.address_line1}
			    field = "address_line1" onChange = {this.handleChange.bind(this)}
			...
			<div className="form-group">
			    ...
			    <div className="col-md-8">
			    <input value = {address.address_line2} tabindex= {tab_index_start + 7} field = "address_line2" onChange = {this.handleChange.bind(this)}
