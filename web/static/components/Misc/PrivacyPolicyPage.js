  ...
  render() {
	var component = (
			<div className = "container">
				...
				<div> This Privacy Policy identifies and describes the information we (Edgar USA, Manaweb Inc.) collect about our users (you). </div>
				...
				<div> You provide information to us when you interact with our website, including when you join our mailing list, create an account, place an order, contact us (via email, telephone, or otherwise), respond to a survey or questionnaire, or enter any other promotion sponsored by us. The information you provide to us may include:  </div>
					<ul>	
						<li> Your contact and shipping information, such as your name, address, telephone number, and email address </li>
						<li> sYour payment information (for example, credit card, banking and/or payment details, banking and your billing address) </li>
				...
				<div> 
					We may collect information by automated means with technologies such as cookies, 
					Web server logs, and user behavior. We may tie this information to information about you that we collect from other sources or that you provide us.  
					We use third-party Web analytics services, such as those of Google Analytics and Atlas, to help us analyze how you use our site. These service providers 
					use cookies and other automated technologies to collect information about you when you visit our site. Learn about Google Analytics and its opt-out 
					choices <a href = "https://tools.google.com/dlpage/gaoptout">here</a> .
				</div>

				<div style = {{"font-size" : "24px"}}> How We Use Your Information </div>
				<div> We use the information you provide to us and information that we collect from you in a variety of ways, including to: </div>
					...
					<ul>
						...
						<li> Notify you about changes to the website, this Privacy Notice and our Terms of Service.</li>
					</ul>
				<div style = {{"font-size" : "24px"}}> How We Share Your Information </div>
				...
				<div> 
					...
					This information is shared with the entities fulfilling
					and shipping your order, such as the merchant and the shipping provider. </div>
				...
				<div style = {{"font-size" : "24px"}}> <b> How we safeguard your Information </b> </div>
					<ul>
						...
						<li> We require non-Edgar USA companies acting on our behalf to protect any Personal Information they may receive in a manner consistent with this Policy. We do not allow them to use such information for any other purpose. </li>	
					</ul>
				...
				<div>
					...
					website to keep you aware of what information we collect, how we use it and under 
					what circumstances we may disclose it. Changes to this Privacy Policy are effective 
					when they are posted on this page.
				</div>

				<div style = {{"font-size" : "24px"}}> Your California Privacy Rights </div>
				<div>
					California Civil Code Section 1798.83 entitles California customers to request 
					information concerning whether a business has disclosed Personal Information to any 
					third parties for the third parties' direct marketing purposes. As stated in this Privacy 
					licy, we will not sell or share your Personal Information with any third party for their 
					direct marketing purposes without your consent. California customers who wish to request 
					further information about our compliance with this law or have questions or concerns about our 
					privacy practices and policies may contact us at privacy@edgarusa.com or write to us at Edgar USA 
					Privacy Policy, 27 Woodfield Lane, Saddle River NJ, 07458.
				</div>
