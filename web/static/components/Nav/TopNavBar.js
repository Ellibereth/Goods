		...
		return (
				<form onSubmit = {this.searchProducts.bind(this)}
					...
					<div className="input-group ">
						<input value = {this.state.search_input} style = {{"height" : "34px"}} onChange = {this.onSearchChange.bind(this)} type="text" className="form-control" placeholder="Search" name="srch-term" id="srch-term"/>
